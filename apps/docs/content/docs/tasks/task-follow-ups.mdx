...
Send follow up messages to add context or make corrections while Rover is working:
...
Once your task is finished, you can ask Rover to create follow-up tasks for any next steps. Rover will create sub-tasks from the current task that you can submit individually.
