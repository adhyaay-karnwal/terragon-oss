...
The Terry CLI let's you interact with Rover directly from the command line. Create tasks, review changes, pull tasks to pick up where you left off, all from your terminal.
...
<Callout type="info">
  **Getting the task ID**:
  ...
  Rover. For example, in `https://terragonlabs.com/tasks/abc123-def456`, the
