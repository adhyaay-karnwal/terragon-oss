...
- **Amp Agent**: Rover now supports [Amp](https://ampcode.com). Configure your Amp API key in [Settings](https://www.terragonlabs.com/settings/agent) to use this powerful alternative to Claude and Codex.
...
- **Branch name prefix customization**: You can now customize the branch prefix added to Rover-generated branches (defaults to `rover/`). Update this in [Settings](https://www.terragonlabs.com/settings).
...
- **Diff Context in GitHub mentions**: Mentioning @terragon-labs in GitHub PR comments now includes context of the diff in the message back to Rover
