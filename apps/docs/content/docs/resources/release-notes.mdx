...
- **Rover Sandbox Environment Variable**: Added `ROVER` environment variable to sandbox environments so you can distinguish when the agent is running in a Rover sandbox versus elsewhere.
