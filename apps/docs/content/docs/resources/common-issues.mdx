...
- Confirm which repositories you've granted access to in <a href="https://www.roverlabs.com/settings/github"><Settings className="inline-block w-4 h-4 mx-1" /> Settings</a>
- Ensure you're logged in with the correct GitHub account

### GitHub PRs are not being created

- Check for branch protection rules that may be preventing Rover from pushing to the branch
- Verify you have push access to the repository

### GitHub @-mentions are not working

- Verify GitHub App is installed on the repository
- Check you have a Rover account with the same GitHub email
- Ensure you're mentioning `@rover-labs` exactly
- Make sure you're tagging `@rover-labs` in a repository you've granted access to in <a href="https://www.roverlabs.com/settings/github"><Settings className="inline-block w-4 h-4 mx-1" /> Settings</a>
