...
- **GitHub Mention**: these allow you to customize the behavior when @rover-labs is mentioned in pull requests, issues, or comments
...
<Tabs items={["Schedule", "GitHub Pull Request", "GitHub Issue", "GitHub Mention", "Manual"]}>
  ...
  <Tab value="GitHub Mention">
    Tasks that run when @rover-labs is mentioned in pull requests, issues, or comments:
...
<Steps>
  <Step>
    ...
    **Automations**](https://www.roverlabs.com/automations) from the sidebar
  </Step>
...
To see all of the past runs and tasks created by an Automation, click on it from [<Workflow className="inline-block w-4 h-4 mx-1" /> **Automations**](https://www.roverlabs.com/automations). This is helpful for ensuring your Automations are completing as expected.
...
<Callout type="info">
For comprehensive information about how Rover protects against prompt injection and other security threats, see our [<Lock className="inline-block w-4 h-4 mx-1" /> **Security & Permissions**](/docs/security-permissions#prompt-injection-protection) documentation.
</Callout>
