...
| Name       | Description                                                                                                                                                              |
| ---------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `TERRAGON` | Always set to `true` when running in a Rover sandbox. You can use this variable to differentiate when the agent/code is running in a Rover sandbox versus locally. |
