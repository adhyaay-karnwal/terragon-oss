---
title: Setup Scripts
description: Configure custom setup scripts that run when your Rover sandbox starts.
---
...
<Callout type="info">
  Configured in your Rover environment settings, this script is private to you and takes precedence over repository scripts.
...
<Steps>
  <Step>
    ...
    **Environments**](https://www.roverlabs.com/environments)
  </Step>
...
Add a `rover-setup.sh` file to the root of your repository
...
You can skip running the `rover-setup.sh` script when creating tasks and automations by toggling the **Skip Repository Setup** setting in the task or automation creation UI.
