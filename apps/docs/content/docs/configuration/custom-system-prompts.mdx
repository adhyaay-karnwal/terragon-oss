...
description: Configure custom system prompts to give Rover specific instructions for your development workflow.
---
...
<Steps>
  <Step>
    Navigate to [<Settings className="inline-block w-4 h-4 mx-1" /> **Settings**](https://www.roverlabs.com/settings/agent)
  </Step>
...
Rover considers both when working on your code.
