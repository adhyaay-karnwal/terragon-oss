---
title: MCP Setup
description: Configure Model Context Protocol (MCP) servers to give Rover access to external tools, databases, and services.
---
...
Model Context Protocol is an open standard that enables AI assistants to interact with external systems through a unified interface. In Rover, MCP servers provide Rover with additional capabilities beyond code editing.
...
Rover supports three types of MCP servers:
...
Here are some popular MCP servers you can use with Rover:
