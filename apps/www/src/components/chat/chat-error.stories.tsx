  ...
  return (
    <div className="p-4 max-w-2xl">
      <ChatError
        ...
        errorInfo={`To github.com:rover-labs/rover.git
! [rejected]        rover/fca1cf -> rover/fca1cf (non-fast-forward)
error: failed to push some refs to 'github.com:rover-labs/rover.git'
...
export const GitPushFailedMobileOverflow: Story = () => {
  const veryLongErrorMessage = `To github.com:rover-labs/rover.git
! [rejected]        rover/very-long-branch-name-that-could-cause-overflow-issues-on-mobile-devices -> rover/very-long-branch-name-that-could-cause-overflow-issues-on-mobile-devices (non-fast-forward)
error: failed to push some refs to 'github.com:rover-labs/rover.git'
