...
import { getGithubPRStatus } from "@rover/shared/github-api/helpers";
import { upsertGithubPR } from "@rover/shared/model/github";
import { updateThread, getThread } from "@rover/shared/model/threads";
import {
...
export async function openPullRequestForThread({
  ...
  prBody += [
    "\n\n",
    "🌿 Generated by [Terry](https://www.roverlabs.com)",
    "\n\n---\n\n",
    "ℹ️ Tag @rover-labs to ask questions and address PR feedback",
    "\n\n",
